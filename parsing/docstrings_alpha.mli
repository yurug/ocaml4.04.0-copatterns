...
val docs_attr : docstring -> Parsetree_alpha.S.attribute

(** Convert item documentation to attributes and add them to an
    attribute list *)
val add_docs_attrs : docs -> Parsetree_alpha.S.attributes ->
  Parsetree_alpha.S.attributes
...
val info_attr : docstring -> Parsetree_alpha.S.attribute

(** Convert field info to attributes and add them to an
    attribute list *)
val add_info_attrs : info -> Parsetree_alpha.S.attributes ->
  Parsetree_alpha.S.attributes
...
val text_attr : docstring -> Parsetree_alpha.S.attribute

(** Convert text to attributes and add them to an attribute list *)
val add_text_attrs : text -> Parsetree_alpha.S.attributes ->
  Parsetree_alpha.S.attributes
