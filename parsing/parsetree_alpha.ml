...
module S = struct
  ...
  *)
  ...
  and copattern =
    {
      pcopat_desc: copattern_desc;
      pcopat_loc: Location.t;
      pcopat_attributes: attributes; (* ... [@id1] [@id2] *)
    }
  ...
  and expression_desc =
    ...
    *)
    ...
    (* [lazy] cofunction : T with Q1 -> E1 | ... | Qn -> En *)
...
*)
  ...
  and type_kind =
    ...
    (* Invariant: non-empty list *)
    | Ptype_cotype of colabel_declaration list
    (* Invariant: non-empty list *)
    | Ptype_open
  ...
  and colabel_declaration =
    {
      pcld_name: string loc;
      pcld_type: core_type;
      pcld_loc: Location.t;
